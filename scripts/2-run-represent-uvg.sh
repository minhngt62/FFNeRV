...
python main.py -e 300 --lower-width 24 --num-blocks 1 \
    --dataset data/uvg/Beauty_1920x1080_120fps_420_8bit_YUV --outf checkpoint \
...
python main.py -e 300 --lower-width 24 --num-blocks 1 \
    --dataset data/uvg/HoneyBee_1920x1080_120fps_420_8bit_YUV --outf checkpoint \
    --fc-hw-dim 9_16_60 --expansion 1 --loss Fusion6 --strides 5 3 2 2 2 \
    --conv-type conv -b 1  --lr 0.0005 --agg-ind -2 -1 1 2 --lw 0.1 --t-dim 64 128 256 512 \
    --resol 1920 1080 # 3.09M
...
python main.py -e 300 --lower-width 24 --num-blocks 1 \
    --dataset data/uvg/Bosphorus_1920x1080_120fps_420_8bit_YUV --outf checkpoint \
    --fc-hw-dim 9_16_60 --expansion 1 --loss Fusion6 --strides 5 3 2 2 2 \
    --conv-type conv -b 1  --lr 0.0005 --agg-ind -2 -1 1 2 --lw 0.1 --t-dim 64 128 256 512 \
    --resol 1920 1080 # 3.09M
...
python main.py -e 300 --lower-width 24 --num-blocks 1 \
    --dataset data/uvg/Jockey_1920x1080_120fps_420_8bit_YUV --outf checkpoint \
    --fc-hw-dim 9_16_60 --expansion 1 --loss Fusion6 --strides 5 3 2 2 2 \
    --conv-type conv -b 1  --lr 0.0005 --agg-ind -2 -1 1 2 --lw 0.1 --t-dim 64 128 256 512 \
    --resol 1920 1080 # 3.09M
...
python main.py -e 300 --lower-width 24 --num-blocks 1 \
    --dataset data/uvg/ReadySteadyGo_1920x1080_120fps_420_8bit_YUV --outf checkpoint \
    --fc-hw-dim 9_16_60 --expansion 1 --loss Fusion6 --strides 5 3 2 2 2 \
    --conv-type conv -b 1  --lr 0.0005 --agg-ind -2 -1 1 2 --lw 0.1 --t-dim 64 128 256 512 \
    --resol 1920 1080 # 3.09M
...
python main.py -e 300 --lower-width 24 --num-blocks 1 \
    --dataset data/uvg/ShakeNDry_1920x1080_120fps_420_8bit_YUV --outf checkpoint \
    --fc-hw-dim 9_16_60 --expansion 1 --loss Fusion6 --strides 5 3 2 2 2 \
...
python main.py -e 300 --lower-width 24 --num-blocks 1 \
    --dataset data/uvg/YachtRide_1920x1080_120fps_420_8bit_YUV --outf checkpoint \
    --fc-hw-dim 9_16_60 --expansion 1 --loss Fusion6 --strides 5 3 2 2 2 \
    --conv-type conv -b 1  --lr 0.0005 --agg-ind -2 -1 1 2 --lw 0.1 --t-dim 64 128 256 512 \
    --resol 1920 1080 # 3.09M
